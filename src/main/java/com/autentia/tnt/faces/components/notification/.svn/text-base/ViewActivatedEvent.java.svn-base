...
public class ViewActivatedEvent extends WidgetEvent {

	private static final long serialVersionUID = -5881641548899207958L;
	...
	protected boolean isAppropriateListener(WidgetListener listener) {
		return listener instanceof ViewActivatedListener;
	}

	@Override
	protected void processListener(WidgetListener listener) {
		((ViewActivatedListener)listener).viewActivated(this);
	}
